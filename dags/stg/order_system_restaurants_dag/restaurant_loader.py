...
from stg.order_system_restaurants_dag.restaurant_reader import RestaurantReader, UserReader, OrderReader
...
class RestaurantLoader:
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            last_loaded_ts_str = workflow_settings[self.LAST_LOADED_TS_KEY]
            ...
            workflow_settings[self.LAST_LOADED_TS_KEY] = max([t["update_ts"] for t in load_queue])
